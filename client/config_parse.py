...
class DpowClientConfig(object):
    ...
    def __init__(self):
        ...
        parser.add_argument('--server', type=str, default='mqtt://139.59.134.66:1883', help="MQTT broker URI")
        ...
        parser.add_argument('--work', type=str, action='store', choices=WORK_TYPES, default="precache", help='Desired work type. Options: any, ondemand, precache (default).')
